...
class Statistics {
    constructor(data) {
        ...
        /** 评级数量
         *  @type {{a:number, s:number, sh:number, ss:number, ssh:number}} */
        this.grade_counts = data?.grade_counts;
        /** acc，范围0-100
         *  @type {number} */
    ...
    toString() {
        ...
        output += "全服排名： #" + ((this.global_rank) ? utils.format_number(this.global_rank) : "没有排名") + "\n";
        output += "本地排名： #" + ((this.country_rank) ? utils.format_number(this.country_rank) : "没有排名") + "\n";
        ...
        output += "银SS(" + utils.format_number(this.grade_counts.ssh) + ") | ";
        output += "SS(" + utils.format_number(this.grade_counts.ss) + ") | ";
        output += "银S(" + utils.format_number(this.grade_counts.sh) + ") | ";
        output += "S(" + utils.format_number(this.grade_counts.s) + ") | ";
        output += "A(" + utils.format_number(this.grade_counts.a) + ") \n";
...
class Score {
    ...
    toString(username) {
        ...
        if (this.pp) output += "PP： " + this.pp.toFixed(2) + "\n";
    ...
    toSimpleString() {
        ...
        output += "成绩： " + ((this.pp) ? (this.pp.toFixed(2) + "pp | ") : "") + (this.accuracy * 100).toFixed(2) + "% | " + this.rank + " | " + utils.format_number(this.score) + " | x" + this.max_combo;
        return output;
    }
    ...
    toMinString() {
        let output = "";
        output += ((this.pp) ? (this.pp.toFixed(2) + "pp \t| ") : "") + (this.accuracy * 100).toFixed(2) + "% \t| " + this.rank + " \t| " + ((this.mods.length > 0) ? this.mods.join("") : "None") + " \t| x" + this.max_combo;
        return output;
    }
}
